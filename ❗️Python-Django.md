...
یک ابزار هوشمند است که به جای نوشتن URLهای دستی برای `ViewSet` ها، به صورت خودکار «یو آر اِل»های RESTful را بر اساس Action های استاندارد (`list`, `create`, `retrieve`, `update`, `destroy`) تولید می‌کند.
