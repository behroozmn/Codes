...
## 6.1. 🅱️ typing_extensions

کار اصلی این ماژول ارائه ویژگی‌های جدید Type Hinting (نوع‌دهی) برای نسخه‌های قدیمی‌تر پایتون است

* سیستم Type Hinting در پایتون به سرعت در حال تکامل است. در هر نسخه از پایتون (مثلاً 3.8، 3.9، 3.10، 3.11 و 3.12)، ویژگی‌های جدیدی به ماژول استاندارد typing اضافه می‌شود.
    * مثلاً TypedDict در پایتون 3.8 اضافه شد.
    * TypeAlias و TypeGuard در پایتون 3.10 اضافه شدند.
    * TypeVarTuple در پایتون 3.11 اضافه شد
    * اگر شما کتابخانه‌ای می‌نویسید که می‌خواهید از پایتون 3.8 تا 3.12 را پشتیبانی کند، نمی‌توانید مستقیماً از typing.TypeAlias استفاده کنید، چون در پایتون 3.8 وجود ندارد و کد شما با خطای ImportError مواجه می‌شود.
* ماژول typing_extensions توسط تیم اصلی توسعه‌دهنده پایتون (Typing SIG) نگهداری می‌شود. این ماژول همیشه جدیدترین ویژگی‌های تایپینگ را در خود دارد، فارغ از اینکه نسخه پایتون شما چه باشد.
* وقتی شما یک ویژگی جدید را از typing_extensions ایمپورت می‌کنید:
    * اگر نسخه پایتون شما به اندازه کافی جدید باشد که آن ویژگی را در ماژول استاندارد typing داشته باشد، typing_extensions آن را مستقیماً از typing بازخوانی (Re-export) می‌کند.
    * اگر نسخه پایتون شما قدیمی باشد، typing_extensions یک پیاده‌سازی سازگار (Compatible Implementation) از آن ویژگی را به شما ارائه می‌دهد تا کد شما بدون خطا اجرا شود.
