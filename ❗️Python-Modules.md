...
### 3.2. ✅️ Min,Max(iterable, *iterables, key, default)
...
## 9.1. 🅱️  [install from local Archive](https://packaging.python.org/en/latest/tutorials/installing-packages/#installing-from-local-archives)
...
# 11. 🅰️ BaseHTTPRequestHandler and HTTPServer
