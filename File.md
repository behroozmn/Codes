...
```bsah
mkfifo /tmp/live_journal # Create «Named Pipe» file
ls -l /tmp/live_journal # prw-r--r-- 1 root root 0 Oct 25 10:00 /tmp/live_journal
sudo journalctl -f -o short-precise > /tmp/live_journal &
sudo lnav -r /var/log /tmp/live_journal
```
