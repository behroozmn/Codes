...
پایتون توسط **Guido van Rossum**[^1] در سال ۱۹۹۱ منتشر شد.
نام این زبان از برنامه تلویزیونی **Monty Python's Flying Circus**[^2] گرفته شده است.

اولین نسخه رسمی، **Python 0.9.0**[^3] بود که در فوریه ۱۹۹۱ منتشر شد.

[^1]: خالق زبان برنامه‌نویسی پایتون و از توسعه‌دهندگان اصلی Google
[^2]: یک کمدی بریتانیایی محبوب در دهه ۱۹۷۰
[^3]: این نسخه شامل مدیریت استثنا، توابع و انواع داده‌ای core بود